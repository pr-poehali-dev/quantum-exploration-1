        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              «ПрофПуть» — это анонимная платформа профориентации, которая помогает людям найти профессию, совпадающую с их личностью, ценностями и природными талантами. Мы убеждены: у каждого человека есть призвание, нужно лишь его распознать.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Студент, меняющий карьеру или просто ищущий себя — тест займёт 10 минут, а результат может изменить всё. Никаких аккаунтов, никаких данных. Только ты и честные вопросы.
            </p>
          </div>
        </div>
      </div>
